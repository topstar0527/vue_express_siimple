...
var Hello = { template: '<p>test</p>' };

var routes = [{ path: '/', component: Hello }];

var router = new _vueRouter2.default({ routes: routes });

var app = new _vue2.default({ router: router }).$mount('#app');

},{"vue-router":2,"vue/dist/vue":3}],2:[function(require,module,exports){
/**
 * vue-router v2.0.3
 * (c) 2016 Evan You
 * @license MIT
